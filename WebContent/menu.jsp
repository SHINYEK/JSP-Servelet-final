			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item pe-5">
					...
					<c:if test="${cartcnt != null}">
					  <span id="cartcnt" class="position-absolute top-0 start-90 translate-middle badge rounded-pill bg-danger"> ${cartcnt}+</span>
					</c:if>
					</a>
				</li>
			</ul>
			<div class="d-flex">
				<c:if test="${uid == null }">
					...
					<c:if test="${uid != null }">					
						...
						<a class="nav-link" href="/mypage">${uname}(${uid})</a>
					</c:if>					
			</div>
		</div>
	</div>
